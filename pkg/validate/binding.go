 ...
 * @LastEditTime: 2022-11-17 17:29:26
...
func init() {
	...
	binding.MustRegValidateFunc("checkNickname", func(args ...interface{}) error {
		if !match.IsNicknameString(conver.ToString(args[0])) {
	...
	binding.MustRegValidateFunc("confirmPassword", func(args ...interface{}) error {
		if conver.ToString(args[0]) != conver.ToString(args[1]) {
